...
import 'package:whatclone/widgets/single_chat_widget.dart';

class ChatListCreen extends StatelessWidget {
  const ChatListCreen({key}) : super(key: key);
